...
final class ETPermissionException extends ETException {
  const ETPermissionException({required super.message, super.details}) : super(code: 'ACCESS_REFUSED');
}

/// An exception thrown when a calendar/event/reminder is not found.
final class ETNotFoundException extends ETException {
  const ETNotFoundException({required super.message, super.details}) : super(code: 'NOT_FOUND');
}

/// An exception thrown when the calendar is not editable.
final class ETNotEditableException extends ETException {
  const ETNotEditableException({required super.message, super.details}) : super(code: 'NOT_EDITABLE');
}

/// An exception thrown when an unknown plugin error occurs.
final class ETGenericException extends ETException {
  const ETGenericException({required super.message, super.details}) : super(code: 'GENERIC_ERROR');
}
...
final class ETNotSupportedByPlatform extends ETException {
  const ETNotSupportedByPlatform({required super.message, super.details}) : super(code: 'NOT_SUPPORTED_BY_PLATFORM');
}
...
final class ETUserCanceledException extends ETException {
  const ETUserCanceledException({required super.message, super.details}) : super(code: 'USER_CANCELED');
}
...
final class ETPresentationException extends ETException {
  const ETPresentationException({required super.message, super.details}) : super(code: 'PRESENTATION_ERROR');
}
