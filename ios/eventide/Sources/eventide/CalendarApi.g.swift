...
enum CalendarApiPigeonInternal {
...
struct Calendar: Hashable, CustomStringConvertible {
  var id: String
  var title: String
  var color: Int64
  var isWritable: Bool
  ...
  static func == (lhs: Calendar, rhs: Calendar) -> Bool {
    ...
    return CalendarApiPigeonInternal.deepEquals(lhs.id, rhs.id) && CalendarApiPigeonInternal.deepEquals(lhs.title, rhs.title) && CalendarApiPigeonInternal.deepEquals(lhs.color, rhs.color) && CalendarApiPigeonInternal.deepEquals(lhs.isWritable, rhs.isWritable) && CalendarApiPigeonInternal.deepEquals(lhs.account, rhs.account)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("Calendar")
    CalendarApiPigeonInternal.deepHash(value: id, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: title, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: color, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: isWritable, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: account, hasher: &hasher)
  }

  public var description: String {
    return "Calendar(id: \(String(describing: id)), title: \(String(describing: title)), color: \(String(describing: color)), isWritable: \(String(describing: isWritable)), account: \(String(describing: account)))"
  }
}

/// Generated class from Pigeon that represents data sent in messages.
struct Event: Hashable, CustomStringConvertible {
  var id: String
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> Event? {
    ...
    let notes: String? = nilOrValue(pigeonVar_list[8])
  ...
  static func == (lhs: Event, rhs: Event) -> Bool {
    ...
    return CalendarApiPigeonInternal.deepEquals(lhs.id, rhs.id) && CalendarApiPigeonInternal.deepEquals(lhs.calendarId, rhs.calendarId) && CalendarApiPigeonInternal.deepEquals(lhs.title, rhs.title) && CalendarApiPigeonInternal.deepEquals(lhs.isAllDay, rhs.isAllDay) && CalendarApiPigeonInternal.deepEquals(lhs.startDate, rhs.startDate) && CalendarApiPigeonInternal.deepEquals(lhs.endDate, rhs.endDate) && CalendarApiPigeonInternal.deepEquals(lhs.reminders, rhs.reminders) && CalendarApiPigeonInternal.deepEquals(lhs.attendees, rhs.attendees) && CalendarApiPigeonInternal.deepEquals(lhs.notes, rhs.notes) && CalendarApiPigeonInternal.deepEquals(lhs.url, rhs.url) && CalendarApiPigeonInternal.deepEquals(lhs.location, rhs.location)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("Event")
    CalendarApiPigeonInternal.deepHash(value: id, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: calendarId, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: title, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: isAllDay, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: startDate, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: endDate, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: reminders, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: attendees, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: notes, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: url, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: location, hasher: &hasher)
  }

  public var description: String {
    return "Event(id: \(String(describing: id)), calendarId: \(String(describing: calendarId)), title: \(String(describing: title)), isAllDay: \(String(describing: isAllDay)), startDate: \(String(describing: startDate)), endDate: \(String(describing: endDate)), reminders: \(String(describing: reminders)), attendees: \(String(describing: attendees)), notes: \(String(describing: notes)), url: \(String(describing: url)), location: \(String(describing: location)))"
  }
}

/// Generated class from Pigeon that represents data sent in messages.
struct Account: Hashable, CustomStringConvertible {
  var id: String
  var name: String
  var type: String
  ...
  static func == (lhs: Account, rhs: Account) -> Bool {
    ...
    return CalendarApiPigeonInternal.deepEquals(lhs.id, rhs.id) && CalendarApiPigeonInternal.deepEquals(lhs.name, rhs.name) && CalendarApiPigeonInternal.deepEquals(lhs.type, rhs.type)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("Account")
    CalendarApiPigeonInternal.deepHash(value: id, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: name, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: type, hasher: &hasher)
  }

  public var description: String {
    return "Account(id: \(String(describing: id)), name: \(String(describing: name)), type: \(String(describing: type)))"
  }
}

/// Generated class from Pigeon that represents data sent in messages.
struct Attendee: Hashable, CustomStringConvertible {
  var name: String
  var email: String
  var type: Int64
  var role: Int64
  ...
  static func == (lhs: Attendee, rhs: Attendee) -> Bool {
    ...
    return CalendarApiPigeonInternal.deepEquals(lhs.name, rhs.name) && CalendarApiPigeonInternal.deepEquals(lhs.email, rhs.email) && CalendarApiPigeonInternal.deepEquals(lhs.type, rhs.type) && CalendarApiPigeonInternal.deepEquals(lhs.role, rhs.role) && CalendarApiPigeonInternal.deepEquals(lhs.status, rhs.status)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("Attendee")
    CalendarApiPigeonInternal.deepHash(value: name, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: email, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: type, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: role, hasher: &hasher)
    CalendarApiPigeonInternal.deepHash(value: status, hasher: &hasher)
  }

  public var description: String {
    return "Attendee(name: \(String(describing: name)), email: \(String(describing: email)), type: \(String(describing: type)), role: \(String(describing: role)), status: \(String(describing: status)))"
  }
}
...
protocol CalendarApi {
  ...
  func createEvent(calendarId: String, title: String, startDate: Int64, endDate: Int64, isAllDay: Bool, notes: String?, url: String?, location: String?, reminders: [Int64]?, completion: @escaping (Result<Event, Error>) -> Void)
  func updateEvent(withId eventId: String, calendarId: String, title: String, startDate: Int64, endDate: Int64, isAllDay: Bool, notes: String?, url: String?, location: String?, reminders: [Int64]?, completion: @escaping (Result<Event, Error>) -> Void)
  func createEventInDefaultCalendar(title: String, startDate: Int64, endDate: Int64, isAllDay: Bool, notes: String?, url: String?, location: String?, reminders: [Int64]?, completion: @escaping (Result<Void, Error>) -> Void)
  func createEventThroughNativePlatform(title: String?, startDate: Int64?, endDate: Int64?, isAllDay: Bool?, notes: String?, url: String?, location: String?, reminders: [Int64]?, completion: @escaping (Result<Void, Error>) -> Void)
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: CalendarApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      createEventChannel.setMessageHandler { message, reply in
        ...
        let notesArg: String? = nilOrValue(args[5])
        let urlArg: String? = nilOrValue(args[6])
        let locationArg: String? = nilOrValue(args[7])
        let remindersArg: [Int64]? = nilOrValue(args[8])
        api.createEvent(calendarId: calendarIdArg, title: titleArg, startDate: startDateArg, endDate: endDateArg, isAllDay: isAllDayArg, notes: notesArg, url: urlArg, location: locationArg, reminders: remindersArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
    ...
    if let api = api {
      updateEventChannel.setMessageHandler { message, reply in
        ...
        let notesArg: String? = nilOrValue(args[6])
        let urlArg: String? = nilOrValue(args[7])
        let locationArg: String? = nilOrValue(args[8])
        let remindersArg: [Int64]? = nilOrValue(args[9])
        api.updateEvent(withId: eventIdArg, calendarId: calendarIdArg, title: titleArg, startDate: startDateArg, endDate: endDateArg, isAllDay: isAllDayArg, notes: notesArg, url: urlArg, location: locationArg, reminders: remindersArg) { result in
          switch result {
          case .success(let res):
            reply(wrapResult(res))
          case .failure(let error):
    ...
    if let api = api {
      createEventInDefaultCalendarChannel.setMessageHandler { message, reply in
        ...
        api.createEventInDefaultCalendar(title: titleArg, startDate: startDateArg, endDate: endDateArg, isAllDay: isAllDayArg, notes: notesArg, url: urlArg, location: locationArg, reminders: remindersArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
    ...
    if let api = api {
      createEventThroughNativePlatformChannel.setMessageHandler { message, reply in
        ...
        let locationArg: String? = nilOrValue(args[6])
        let remindersArg: [Int64]? = nilOrValue(args[7])
        api.createEventThroughNativePlatform(title: titleArg, startDate: startDateArg, endDate: endDateArg, isAllDay: isAllDayArg, notes: notesArg, url: urlArg, location: locationArg, reminders: remindersArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
